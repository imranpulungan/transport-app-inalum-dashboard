            ...
            <div class="col-sm-auto">
                <div>
                    <?php if (hasPermission('IN')) : ?>
                        <!-- <button class="btn btn-success" onclick="open('<?= baseUri(MODAD . 'trans/pekerjaan/form/add'); ?>', '', 'width=' + screen.width + ',height=' + screen.height + '').onload(function(){document.documentElement.requestFullscreen()})"><i class="ri-add-line align-bottom me-1"></i> Tambah <?= $title; ?></button> -->
                        ...
                        <a href="<?= baseUri(MODAD . 'trans/pekerjaan/form/add'); ?>" target="_blank" rel="noopener noreferrer">
                        ...
                        <div class="align-items-center d-flex">
                            ...
                            <div class="ml-auto d-none d-sm-none d-md-block">
                                <div class="input-group">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#modalFilter" id="btnModalFilter" class="btn btn-secondary btn-label rounded-start ms-1">
                                        <i class="ri-filter-line label-icon align-middle fs-16 me-2"></i>
                                        Filter
                                        <!-- <div style="font-size: 10px;position: absolute;left: -2px;top: -10px;background: green;padding: 5px;border-radius: 50%;">
                                            <span>asd</span>
                                        </div>   -->
                                    </button>
                                </div>
                                ...
                                <table class="table align-middle mb-0" id="AsTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th style="width:15%"><?= getLangKey('pekerjaan_col_12'); ?></th>
                                            <!-- Hidden -->
                                            <th><?= getLangKey('pekerjaan_col_4'); ?></th>
                                            <th><?= getLangKey('pekerjaan_col_5'); ?></th>
                                            <th><?= getLangKey('pekerjaan_col_6'); ?></th>
...
<?php if (hasPermission('IN') && $no == true) : ?>
...
<?php if (hasPermission('UP') && $no == true) : ?>
...
<div class="modal fade" id="modalFilter" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content border-0 overflow-hidden">
            <div class="card mb-0">
                <div class="card-body text-muted">
                    <form id="formFilter">
                        <div class="mb-3">
                            <label for="name" class="form-label">Equipment <span class="text-danger">*</span></label>
                            <select class="form-select select2" name="filter_equipment" id="filter_equipment">
                                <option></option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="name" class="form-label">Kategori Pekerjaan <span class="text-danger">*</span></label>
                            <select class="form-select select2" name="filter_kategori_pekerjaan" id="filter_kategori_pekerjaan">
                                <option></option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="name" class="form-label">Kategori Trouble <span class="text-danger">*</span></label>
                            <select class="form-select select2" name="filter_kategori_trouble" id="filter_kategori_trouble">
                                <option></option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="name" class="form-label">Progress <span class="text-danger">*</span></label>
                            <!-- <div class="row">
                                <div class="col-md-6">
                            ...
                            <select class="form-select select2" name="filter_progress" id="filter_progress">
                                <option></option>
                                <option value="1">Progress <= 30%</option>
                                <option value="2">31% >= Progress <= 50%</option>
                                <option value="3">51% >= Progress <= 70%</option>
                                <option value="4">Progress >= 71%</option>
                            </select>
                        </div>
                    </div>
                </div>
