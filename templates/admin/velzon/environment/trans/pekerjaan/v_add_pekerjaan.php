                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="table-nested no-padding">
                                        ...
                                        <select class="form-select border-0 table-input select2 no-autoclose use-template" data-template="onlyInisial" multiple="multiple" name="pekerja_pelaksana[]" id="pekerja_pelaksana"></select>
