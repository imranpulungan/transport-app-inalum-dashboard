            ...
            <div class="col-sm">
                <div class="d-flex justify-content-sm-first gap-2">
                    <div class="search-box w-25">
                        <input type="text" class="form-control ps-2 pe-2 bg-white" name="kd_service" id="kd_service" placeholder="Parent Code..." readonly value="<?= uniqIdReal(30); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-auto">
                <div>
                    <?php if (hasPermission('IN')) : ?>
                        <button type="button" class="btn btn-success" id="submit"><i class="ri-add-line align-bottom me-1"></i> Simpan <?= getLangKey('title') ?></button>
                    <?php endif; ?>
