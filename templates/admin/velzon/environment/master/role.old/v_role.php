    ...
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-3">
            ...
            <div class="col-sm-auto">
                <div>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="ri-add-line align-bottom me-1"></i> Tambah User</button>
                            ...
                            <div class="table-responsive table-card">
                                <table class="table align-middle table-nowrap mb-0" id="AsTable">
                                    <thead class="table-light">
                                        <tr>
                                            <th style="width:1%"><?= getLangKey('show_user_col_1'); ?></th>
                                            <th style="width:5%"><?= getLangKey('show_user_col_2'); ?></th>
                                            <th style="width:10%"><?= getLangKey('show_user_col_3'); ?></th>
                                            <th><?= getLangKey('show_user_col_4'); ?></th>
                                            <th style="width:10%"><?= getLangKey('show_user_col_5'); ?></th>
                                            <th><?= getLangKey('show_user_col_6'); ?></th>
                                            <th style="width:12%"><?= getLangKey('show_user_col_7'); ?></th>
                                            <th><?= getLangKey('hide_user_col_1'); ?></th>
                                            <th><?= getLangKey('hide_user_col_2'); ?></th>
                                            <th><?= getLangKey('hide_user_col_3'); ?></th>
                                            <th><?= getLangKey('hide_user_col_4'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
                    ...
                    <div class="modal-body pb-2">
                        ...
                        <div class="row">
                            <div class="mb-3 col-lg-6">
                                <label><?= getLangKey('user_add_modal_label_namecode'); ?> <span class="text-danger">*</span></label>
                                <input type="number" required class="form-control" placeholder="<?= getLangKey('user_add_modal_label_namecode_plc'); ?>" data-error="<?= getLangKey('user_add_modal_label_namecode_error'); ?>" id="namecode" name="namecode" />
                                <div class="invalid-feedback"><?= getLangKey('user_add_modal_label_namecode_error'); ?></div>
                            </div>
                            <div class="mb-3 col-lg-6">
                                <label><?= getLangKey('user_add_modal_label_inisial'); ?> <span class="text-danger">*</span></label>
                                <input type="text" required class="form-control" placeholder="<?= getLangKey('user_add_modal_label_inisial_plc'); ?>" data-error="<?= getLangKey('user_add_modal_label_inisial_error'); ?>" id="inisial" name="inisial" />
                                <div class="invalid-feedback"><?= getLangKey('user_add_modal_label_inisial_error'); ?></div>
                            </div>
                        </div>
            ...
            <form autocomplete="off" method="post" data-type="save" id="form_edit" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    ...
                    <div class="modal-body pb-2">
                        ...
                        <div class="row">
                            <div class="mb-3 col-lg-6">
                                <label><?= getLangKey('user_edit_modal_label_namecode'); ?> <span class="text-danger">*</span></label>
                                <input type="number" required class="form-control" placeholder="<?= getLangKey('user_edit_modal_label_namecode_plc'); ?>" id="namecode_edit" name="namecode_edit" />
                                <div class="invalid-feedback"><?= getLangKey('user_edit_modal_label_namecode_error'); ?></div>
                            </div>
                            <div class="mb-3 col-lg-6">
                                <label><?= getLangKey('user_edit_modal_label_inisial'); ?> <span class="text-danger">*</span></label>
                                <input type="text" required class="form-control" placeholder="<?= getLangKey('user_edit_modal_label_inisial_plc'); ?>" id="inisial_edit" name="inisial_edit" />
                                <div class="invalid-feedback"><?= getLangKey('user_edit_modal_label_inisial_error'); ?></div>
                            </div>
                        </div>
                        <div class="">
