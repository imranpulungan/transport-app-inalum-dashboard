    ...
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-3">
            ...
            <div class="col-sm-auto">
                <div>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="ri-add-line align-bottom me-1"></i> <?= getLangKey('kendaraan_btn_add'); ?></button>
                            ...
                            <div class="table-responsive table-card">
                                <table class="table align-middle table-nowrap mb-0" style="margin-top: 0px !important;" id="AsTable">
                                    <thead class="table-light">
                                        <tr>
                                            <th><?= getLangKey('show_kendaraan_col_1'); ?></th>
                                            <th><?= getLangKey('show_kendaraan_col_2'); ?></th>
                                            <!-- <th><?= getLangKey('show_kendaraan_col_3'); ?></th> -->
                                            <th><?= getLangKey('show_kendaraan_col_4'); ?></th>                                            
                                            <!-- <th><?= getLangKey('show_kendaraan_col_5'); ?></th>                                            
                                            <th><?= getLangKey('show_kendaraan_col_6'); ?></th>                                             -->
                                            <th><?= getLangKey('show_kendaraan_col_7'); ?></th>                                            
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
            ...
            <form autocomplete="off" method="post" data-type="save" id="form_tambah" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0"><?= getLangKey('kendaraan_add_modal_title'); ?></h4>
                    ...
                    <div class="modal-body pb-2">
                        <div class="mb-3">
                            <label><?= getLangKey('kendaraan_add_modal_label_plat'); ?> <span class="text-danger">*</span></label>
                            <input type="text" required class="form-control" placeholder="<?= getLangKey('kendaraan_add_modal_label_plat_plc'); ?>" data-error="<?= getLangKey('kendaraan_add_modal_label_plat_error'); ?>" id="plat_kendaraan" name="plat_kendaraan" />
                            <div class="invalid-feedback"><?= getLangKey('kendaraan_add_modal_label_plat_error'); ?></div>
                        </div>
                        <div class="mb-3">
                            <label><?= getLangKey('kendaraan_add_modal_label_model'); ?> <span class="text-danger">*</span></label>
                            <input type="text" required class="form-control" placeholder="<?= getLangKey('kendaraan_add_modal_label_model_plc'); ?>" data-error="<?= getLangKey('kendaraan_add_modal_label_model_error'); ?>" id="model" name="model" />
                            <div class="invalid-feedback"><?= getLangKey('kendaraan_add_modal_label_model_error'); ?></div>
                        </div>                        
                    </div>
    ...
    <div class="modal fade" id="modalEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form autocomplete="off" method="post" data-type="save" id="form_edit" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0" id="modal_header_edit"><?= getLangKey('kendaraan_edit_modal_title'); ?></h4>
                        <button type="button" class="btn-close tutup"></button>
                    </div>
                    <div class="alert alert-warning rounded-0 mb-0">
                        <p class="mb-0">Tanda <span class="fw-semibold">(*)</span> Wajib Diisi</p>
                    ...
                    <div class="modal-body pb-2">
                        <div class="mb-3">
                            <label><?= getLangKey('kendaraan_add_modal_label_plat'); ?> <span class="text-danger">*</span></label>
                            <input type="text" required class="form-control" placeholder="<?= getLangKey('kendaraan_add_modal_label_plat_plc'); ?>" data-error="<?= getLangKey('kendaraan_add_modal_label_plat_error'); ?>" id="edit_plat_kendaraan" name="plat_kendaraan" />
                            <div class="invalid-feedback"><?= getLangKey('kendaraan_add_modal_label_plat_error'); ?></div>
                        </div>
                        <div class="mb-3">
                            <label><?= getLangKey('kendaraan_add_modal_label_model'); ?> <span class="text-danger">*</span></label>
                            <input type="text" required class="form-control" placeholder="<?= getLangKey('kendaraan_add_modal_label_model_plc'); ?>" data-error="<?= getLangKey('kendaraan_add_modal_label_model_error'); ?>" id="edit_model" name="model" />
                            <div class="invalid-feedback"><?= getLangKey('kendaraan_add_modal_label_model_error'); ?></div>
                        </div>                        
                    </div>
                    <div class="dropdown-divider"></div>
...
<?php endif; ?>
    ...
    <div class="modal fade" id="modalQRCode" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form autocomplete="off" method="post" data-type="save" id="form_qr" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0" id="modal_header_edit"><?= getLangKey('kendaraan_qrcode_display'); ?></h4>
                        <button type="button" class="btn-close tutup"></button>
                    </div>
                    <div class="modal-body pb-2 pt-1">
                        <div class="mb-3">
                            <label id="qrcode-plat-number"></label>
                            <div id="qrcode">
                                <img id="qrcode-canvas-image"src="" alt="QR-CODE TIDAK DITEMUKAN" srcset="">
                            </div>                            
                        </div>                                           
                    </div>
                    <div class="dropdown-divider"></div>
                    <div class="modal-footer">
                        <button type="button" class="tutup btn btn-danger font-weight-bold">Tutup</button>
                        <button type="button" class="btn btn-primary font-weight-bold" id="submitGenerateQR">Generate Ulang</button>
                    </div>
                </div>
            </form>
        </div>
