    ...
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-3">
            ...
            <div class="col-sm-auto">
                <div>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="ri-add-line align-bottom me-1"></i> <?= getLangKey('perusahaan_btn_add'); ?></button>
                            ...
                            <div class="table-responsive table-card">
                                <table class="table align-middle table-nowrap mb-0" style="margin-top: 0px !important;" id="AsTable">
                                    <thead class="table-light">
                                        <tr>
                                            <th><?= getLangKey('show_perusahaan_col_1'); ?></th>
                                            <th><?= getLangKey('show_perusahaan_col_2'); ?></th>
                                            <th><?= getLangKey('show_perusahaan_col_4'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
            ...
            <form autocomplete="off" method="post" data-type="save" id="form_tambah" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0"><?= getLangKey('perusahaan_add_modal_title'); ?></h4>
                    ...
                    <div class="modal-body pb-2">
                        <div class="">
                            <label for="name" class="form-label"><?= getLangKey('perusahaan_add_modal_label_nama'); ?> <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="<?= getLangKey('perusahaan_add_modal_label_nama_plc'); ?>" required>
                            <div class="invalid-feedback"><?= getLangKey('perusahaan_add_modal_label_nama_error'); ?></div>
                        </div>
                        <!-- <div class="">
                            <label><?= getLangKey('perusahaan_add_modal_label_alias'); ?> <span class="text-danger">*</span></label>
                            <input type="text" required class="form-control" placeholder="<?= getLangKey('perusahaan_add_modal_label_alias_plc'); ?>" data-error="<?= getLangKey('perusahaan_add_modal_label_alias_error'); ?>" id="alias" name="alias" />
                            <div class="invalid-feedback"><?= getLangKey('perusahaan_add_modal_label_alias_error'); ?></div>
                        </div> -->
                    </div>
    ...
    <div class="modal fade" id="modalEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form autocomplete="off" method="post" data-type="save" id="form_edit" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0" id="modal_header_edit"><?= getLangKey('perusahaan_edit_modal_title'); ?></h4>
                        <button type="button" class="btn-close tutup"></button>
                    </div>
                    <div class="alert alert-warning rounded-0 mb-0">
                        <p class="mb-0">Tanda <span class="fw-semibold">(*)</span> Wajib Diisi</p>
                    ...
                    <div class="modal-body pb-2">
                        <div class="">
                            <label for="name" class="form-label"><?= getLangKey('perusahaan_edit_modal_label_nama'); ?> <span class="text-danger">*</span></label>
                            <input type="hidden" name="id_perusahaan_edit" id="id_perusahaan_edit">
                            <input type="text" class="form-control" id="nama_edit" name="nama_edit" placeholder="<?= getLangKey('perusahaan_edit_modal_label_nama_plc'); ?>" required>
                            <div class="invalid-feedback"><?= getLangKey('perusahaan_edit_modal_label_nama_error'); ?></div>
                        </div>
                        <!-- <div class="">
                            <label><?= getLangKey('perusahaan_edit_modal_label_alias'); ?> <span class="text-danger">*</span></label>
                            <input type="text" required class="form-control" placeholder="<?= getLangKey('perusahaan_edit_modal_label_alias_plc'); ?>" id="alias_edit" name="alias_edit" />
                            <div class="invalid-feedback"><?= getLangKey('perusahaan_edit_modal_label_alias_error'); ?></div>
                        </div> -->
                    </div>
                    <div class="dropdown-divider"></div>
                    <div class="modal-footer">
