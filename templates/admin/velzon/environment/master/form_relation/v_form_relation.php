            ...
            <div class="col-sm-auto">
                <div>
                    <?php if (hasPermission('IN')) : ?>
                        <button class="btn btn-success tombolTambah" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="ri-add-line align-bottom me-1"></i> <?= getLangKey('form_relation_btn_add'); ?></button>
                    <?php endif; ?>
                            ...
                            <div class="table-responsive table-card">
                                <table class="table align-middle table-nowrap mb-0" id="AsTable">
                                    <thead class="table-light">
                                        <tr>
                                            <th style="width:1%"><?= getLangKey('show_form_relation_col_1'); ?></th>
                                            <th><?= getLangKey('show_form_relation_col_2'); ?></th>
                                            <th style="width:12%"><?= getLangKey('show_form_relation_col_3'); ?></th>
                                            <th><?= getLangKey('hide_form_relation_col_1'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
            ...
            <form autocomplete="off" method="post" data-type="save" id="form_tambah" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0"><?= getLangKey('form_relation_add_modal_title'); ?></h4>
                        <button type="button" class="btn-close tutup"></button>
                    </div>
                    <div class="alert alert-warning rounded-0 mb-0">
                        <p class="mb-0">Tanda <span class="fw-semibold">(*)</span> Wajib Diisi</p>
                    </div>
                    <div class="modal-body form_relationDelay pb-2">
                        <div class="mb-3">
                            <label for="name" class="form-label"><?= getLangKey('form_relation_add_modal_label_form_header'); ?> <span class="text-danger">*</span></label>
                            <select class="form-control select2" placeholder="<?= getLangKey('form_relation_add_modal_label_form_header_plc'); ?>" data-error="<?= getLangKey('form_relation_add_modal_label_form_header_error'); ?>" id="form_header" name="form_header" required>
                            </select>
                            <!-- <input type="text" class="form-control" id="nm_form_header" name="nm_form_header" placeholder="<?= getLangKey('form_relation_add_modal_label_form_header_plc'); ?>" required> -->
                            <div class="invalid-feedback"><?= getLangKey('form_relation_add_modal_label_form_header_error'); ?></div>
                        </div>
                        <div class="form-group" style="margin-bottom: 0;">
                            <label><?= getLangKey('form_relation_add_modal_label_form_header_form_relation'); ?> <span class="text-danger">*</span></label>
                            <div class="table-responsive" style="height:56vh">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5">
                                    <thead style="position: sticky;top: 0;z-index:1">
                                        <tr id="tr-form_body-jenis"></tr>
                                    </thead>
                                    <tbody id="tr-list-form_body"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen" role="document">
            <form autocomplete="off" method="post" data-type="save" id="form_edit" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0" id="modal_header_edit"><?= getLangKey('form_relation_edit_modal_title'); ?></h4>
                        <button type="button" class="btn-close tutup"></button>
                    </div>
                    <!-- <div class="alert alert-warning rounded-0 mb-0">
                        <p class="mb-0">Tanda <span class="fw-semibold">(*)</span> Wajib Diisi</p>
                    </div> -->
                    <div class="modal-body form_relationDelayEdit pb-2">
                        <div class="form-group" style="margin-bottom: 0;">
                            <input type="hidden" name="form_header_edit" id="form_header_edit">
                            <label><?= getLangKey('form_relation_edit_modal_label_form_header_form_relation'); ?> <span class="text-danger">*</span></label>
                            <div class="table-responsive" style="height:74vh">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5">
                                    <thead style="position: sticky;top: 0;z-index:1">
                                        <tr id="tr-form_body-jenis-edit"></tr>
                                    </thead>
                                    <tbody id="tr-list-form_body-edit"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
                    <div style="display: none;">
                        <textarea id="form_bodyEdit" name="form_bodyEdit"></textarea>
                    </div>
                    <div class="dropdown-divider"></div>
                    <div class="modal-footer">
                        <button type="button" class="tutup btn btn-danger font-weight-bold">Batal</button>
