    ...
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-3">
            ...
            <div class="col-sm-auto">
                <div>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="ri-add-line align-bottom me-1"></i> <?= getLangKey('jenis_btn_add'); ?></button>
                            ...
                            <div class="table-responsive table-card">
                                <table class="table align-middle table-nowrap mb-0" id="AsTable">
                                    <thead class="table-light">
                                        <tr>
                                            <th style="width:1%"><?= getLangKey('show_jenis_col_1'); ?></th>
                                            <th style="width:15%"><?= getLangKey('show_jenis_col_2'); ?></th>
                                            <th><?= getLangKey('show_jenis_col_3'); ?></th>
                                            <th><?= getLangKey('show_jenis_col_4'); ?></th>
                                            <th style="width:12%"><?= getLangKey('show_jenis_col_5'); ?></th>
                                            <th><?= getLangKey('hide_jenis_col_1'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
            ...
            <form autocomplete="off" method="post" data-type="save" id="form_tambah" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0"><?= getLangKey('jenis_add_modal_title'); ?></h4>
                    ...
                    <div class="modal-body pb-2">
                        <div class="mb-3">
                            <label for="name" class="form-label"><?= getLangKey('jenis_add_modal_label_no_dokumen'); ?> <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="no_dokumen" name="no_dokumen" placeholder="<?= getLangKey('jenis_add_modal_label_no_dokumen_plc'); ?>" required>
                            <div class="invalid-feedback"><?= getLangKey('jenis_add_modal_label_no_dokumen_error'); ?></div>
                        </div>
                        <div class="mb-3">
                            <label for="name" class="form-label"><?= getLangKey('jenis_add_modal_label_nm_jenis'); ?> <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nm_jenis" name="nm_jenis" placeholder="<?= getLangKey('jenis_add_modal_label_nm_jenis_plc'); ?>" required>
                            <div class="invalid-feedback"><?= getLangKey('jenis_add_modal_label_nm_jenis_error'); ?></div>
                        </div>
                        <div class="">
                            <label><?= getLangKey('jenis_add_modal_label_judul'); ?> <span class="text-danger">*</span></label>
                            <input type="text" required class="form-control" placeholder="<?= getLangKey('jenis_add_modal_label_judul_plc'); ?>" data-error="<?= getLangKey('jenis_add_modal_label_judul_error'); ?>" id="judul" name="judul" />
                            <div class="invalid-feedback"><?= getLangKey('jenis_add_modal_label_judul_error'); ?></div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form autocomplete="off" method="post" data-type="save" id="form_edit" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0" id="modal_header_edit"><?= getLangKey('jenis_edit_modal_title'); ?></h4>
                        <button type="button" class="btn-close tutup"></button>
                    </div>
                    <div class="alert alert-warning rounded-0 mb-0">
                        <p class="mb-0">Tanda <span class="fw-semibold">(*)</span> Wajib Diisi</p>
                    ...
                    <div class="modal-body pb-2">
                        <div class="mb-3">
                            <label for="name" class="form-label"><?= getLangKey('jenis_edit_modal_label_no_dokumen'); ?> <span class="text-danger">*</span></label>
                            <input type="hidden" name="id_jenis_edit" id="id_jenis_edit">
                            <input type="text" class="form-control" id="no_dokumen_edit" name="no_dokumen_edit" placeholder="<?= getLangKey('jenis_edit_modal_label_no_dokumen_plc'); ?>" required>
                            <div class="invalid-feedback"><?= getLangKey('jenis_edit_modal_label_no_dokumen_error'); ?></div>
                        </div>
                        <div class="mb-3">
                            <label for="name" class="form-label"><?= getLangKey('jenis_edit_modal_label_nm_jenis'); ?> <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nm_jenis_edit" name="nm_jenis_edit" placeholder="<?= getLangKey('jenis_edit_modal_label_nm_jenis_plc'); ?>" required>
                            <div class="invalid-feedback"><?= getLangKey('jenis_edit_modal_label_nm_jenis_error'); ?></div>
                        </div>
                        <div class="">
                            <label><?= getLangKey('jenis_edit_modal_label_judul'); ?> <span class="text-danger">*</span></label>
                            <input type="text" required class="form-control" placeholder="<?= getLangKey('jenis_edit_modal_label_judul_plc'); ?>" id="judul_edit" name="judul_edit" />
                            <div class="invalid-feedback"><?= getLangKey('jenis_edit_modal_label_judul_error'); ?></div>
                        </div>
                    </div>
                    <div class="dropdown-divider"></div>
                    <div class="modal-footer">
