                            ...
                            <div class="table-responsive table-card">
                                <table class="table align-middle table-nowrap mb-0" id="AsTable">
                                    <thead class="table-light">
                                        <tr>
                                            <th style="width:1%"><?= getLangKey('grup_kerja_col_1'); ?></th>
                                            <th><?= getLangKey('grup_kerja_col_2'); ?></th>
                                            <th><?= getLangKey('grup_kerja_col_3'); ?></th>
                                            <th style="width:16%"><?= getLangKey('grup_kerja_col_4'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
            ...
            <form autocomplete="off" method="post" data-type="save" id="form_tambah" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0"><?= getLangKey('grup_kerja_add_modal_title'); ?></h4>
                    ...
                    <div class="modal-body pb-2">
                        <div class="mb-3">
                            <label for="name" class="form-label"><?= getLangKey('grup_kerja_add_modal_label_nama'); ?> <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nama_grup_kerja" name="nama_grup_kerja" placeholder="<?= getLangKey('grup_kerja_add_modal_label_nama_plc'); ?>" required>
                            <div class="invalid-feedback"><?= getLangKey('grup_kerja_add_modal_label_nama_error'); ?></div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form autocomplete="off" method="post" data-type="save" id="form_edit" class="needs-validation" novalidate>
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0" id="modal_header_edit"><?= getLangKey('grup_kerja_edit_modal_title'); ?></h4>
                        <button type="button" class="btn-close tutup"></button>
                    </div>
                    <div class="alert alert-warning rounded-0 mb-0">
                        <p class="mb-0">Tanda <span class="fw-semibold">(*)</span> Wajib Diisi</p>
                    ...
                    <div class="modal-body pb-2">
                        <div class="mb-3">
                            <label for="name" class="form-label"><?= getLangKey('grup_kerja_edit_modal_label_nama'); ?> <span class="text-danger">*</span></label>
                            <input type="hidden" name="kd_grup_kerja_edit" id="kd_grup_kerja_edit">
                            <input type="text" class="form-control" id="nama_grup_kerja_edit" name="nama_grup_kerja_edit" placeholder="<?= getLangKey('grup_kerja_edit_modal_label_nama_plc'); ?>" required>
                            <div class="invalid-feedback"><?= getLangKey('grup_kerja_edit_modal_label_nama_error'); ?></div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="tutup btn btn-danger font-weight-bold">Batal</button>
