...
var ExAsUser = (function() {
                            ...
                            if (isReady === false) {
                                ...
                                tb.rows().every(function(rowIdx, tableLoop, rowLoop) {
                                    ...
                                    if (data[5] == item.id) {
                                        ...
                                        if (data[2] !== item.nm_action) {
                                            tb.cell(rowIdx, 2)
                                                .data(item.nm_action)
                                        }

                                        if (data[3] !== item.deskripsi) {
                                            tb.cell(rowIdx, 3)
                                                .data(item.deskripsi)
                                        }
    ...
    var updateClickTrigger = function() {
        $("table tbody").on("click", ".tombolEdit", function() {
            ...
            $('#id_action_edit').val(drop[5])
            $('#code_edit').val(drop[1])
            $('#nama_edit').val(drop[2])
            $('#deskripsi_edit').val(drop[3])
